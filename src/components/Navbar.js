      ...
      <nav className="bg-white border-gray-200 shadow-md fixed w-full z-50 top-0 start-0">
        <div className="flex flex-wrap items-center justify-between mx-auto p-4 tablet-m:px-8 laptop-s:p-7 desktop-m:p-10">
          ...
          {isModalOpen && (
            ...
            >
              <div className="border border-orange-600 modal-container bg-white w-11/12 tablet:max-w-md mx-auto rounded-lg shadow-lg z-50 overflow-y-auto">
                <div className="modal-content py-4 text-left px-6">
                  ...
                  <div className="my-3">
                    ...
                    <div class="flex">
                      <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md">
                        <svg
                          className="w-5 h-7 text-gray-500"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                        >
                  ...
                  <div className="flex justify-end pt-2">
                    <button className="focus:outline-none px-4 bg-orange-500 p-3 ml-3 rounded-lg text-white hover:bg-orange-400">
                      Submit
                    </button>
                  </div>
                </div>
