      ...
      <div className="font-satoshi overflow-x-hidden">
        <div className="cont tablet:px-8">
          ...
          <section className="mx-auto mt-5">
            ...
            <div className="laptopCont px-8 hidden tablet-m:flex justify-between items-center">
              <div className="shadow-lg bg-white flex flex-col justify-center items-center w-[100%] tablet:w-full tablet:my-4  tablet:h-64 tablet-m:w-[33%] tablet-m:h-[40rem] h-[26rem] my-5">
                <div
                  className="bg-cover bg-center w-[100%] tablet:w-[100%] h-full"
                  style={{ backgroundImage: `url(${maamT})` }}
                ></div>
