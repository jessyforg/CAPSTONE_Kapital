    ...
    <div>
      <div className="cont px-8">
        ...
        <div className="swiper mySwiperEvent">
          <div className="swiper-wrapper tablet:h-[17rem] tablet-m:h-[20rem] tablet:w-full">
            <div className="swiper-slide shadow-lg bg-white flex flex-col justify-center items-center w-full tablet:h-[15rem] tablet-m:h-[18rem] h-40 my-2">
              <div
                className="bg-cover bg-center w-full h-full tablet:h-[15rem] tablet-m:h-[18rem]"
            ...
            <div className="swiper-slide shadow-lg bg-white flex flex-col justify-center items-center tablet:h-[15rem] tablet-m:h-[18rem] w-full h-40 my-2">
              <div
                className="bg-cover bg-center w-full h-full tablet:h-[15rem] tablet-m:h-[18rem]"
            ...
            <div className="swiper-slide shadow-lg bg-white flex flex-col justify-center items-center w-full h-40 tablet:h-[15rem] tablet-m:h-[18rem] my-2">
              <div
                className="bg-cover bg-center w-full h-full tablet:h-[15rem] tablet-m:h-[18rem]"
